          ...
          <div class="card">
            ...
            <div class="card-body table-responsive p-0">
              <div class="card card-info">
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('update.tag', $tag->id) }}" method="post">
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" value="{{ $tag->title }}" placeholder="عنوان را وارد کنید">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="name" value="{{ $tag->name }}" placeholder="عنوان را وارد کنید">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea name="dic" class="form-control">{{ $tag->dic }}</textarea>
                      </div>
                    </div>
                  </div>
                  <!-- /.card-body -->
