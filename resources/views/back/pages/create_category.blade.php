                  ...
                  <form class="form-horizontal" action="{{ route('category.store') }}" method="post">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="name" id="inputEmail3" placeholder="عنوان را وارد کنید">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="slug" id="inputPassword3" placeholder="نام مستعار را وارد کنید">
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
                    <div class="card-footer">
                      <button type="submit" class="btn btn-info">اضافه کردن دسته بندی جدید</button>
